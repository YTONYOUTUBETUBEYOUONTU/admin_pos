<template>
    ...
    <a rel="noopener noreferrer" href="#" class="flex items-center flex-shrink-0 px-5 py-3 space-x-2 rounded-t-lg text-gray-900">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
        ...
        <path d="M2 3h6a4 4 0 0 1 4 4v14a3
                 3 0 0 0-3-3H2z"></path>
        <path d="M22 3h-6a4 4 0 0 0-4
                 4v14a3 3 0 0 1 3-3h7z"></path>
      </svg>
      <span>Corrupti</span>
    </a>
    <a rel="noopener noreferrer" href="#" class="flex items-center flex-shrink-0 px-5 py-3 space-x-2 text-gray-600">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
        ...
        <polygon points="12 2 15.09 8.26 22 9.27 17
                        ...
                        5.82 21.02 7 14.14 2
                        9.27 8.91 8.26 12 2"></polygon>
      </svg>
      <span>Excepturi</span>
    </a>
    <a rel="noopener noreferrer" href="#" class="flex items-center flex-shrink-0 px-5 py-3 space-x-2 text-gray-600">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
        ...
        <polygon points="16.24 7.76 14.12 14.12
                        7.76 16.24 9.88 9.88
                        16.24 7.76"></polygon>
      </svg>
  ...
  <section class="py-10 bg-gray-100">
    <div class="mx-auto grid max-w-6xl grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <a href="#">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M2.25 3h1.386c.51 0
                         .955.343 1.087.835l.383 1.437M7.5 14.25a3
                         ...
                         0 .75.75 0 011.5 0zm12.75 0a.75.75 0
          ...
          <div class="mt-1 p-2">
            ...
            <div class="mt-3 flex items-end justify-between">
              ...
              <div
                class="flex items-center space-x-1.5 rounded-lg bg-blue-500
                       px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                     viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="h-4 w-4">
                  <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="#">
          <div class="relative flex items-end overflow-hidden rounded-xl">
            <img
              ...
              alt="Hotel Photo"/>
            <div class="absolute bottom-3 left-3 inline-flex items-center
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-400"
                ...
                <path
                  d="M9.049 2.927c.3-.921 1.603-.921
                     ...
                     1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                  ...
                  <path stroke-linecap="round" stroke-linejoin="round"
                        d="M2.25 3h1.386c.51 0
                           ...
                           1.437M7.5 14.25a3 3
                           0 00-3 3h15.75m-12.75-3h11.218
                           c1.121-2.3 2.1-4.684
                           2.924-7.138a60.114 60.114 0
                           00-16.536-1.84M7.5
                           14.25L5.106 5.272M6
                           20.25a.75.75 0 11-1.5
                           0 .75.75 0 011.5
                           0zm12.75 0a.75.75 0
                           11-1.5 0 .75.75 0
                           011.5 0z"/>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M2.25 3h1.386c.51 0
                         .955.343 1.087.835l.383
                         1.437M7.5 14.25a3 3
                         0 00-3 3h15.75m-12.75-3
                         h11.218c1.121-2.3
                         2.1-4.684 2.924-7.138
                         a60.114 60.114 0
                         00-16.536-1.84M7.5
                         14.25L5.106
                         5.272M6
      ...
      <!-- Tarjeta 4 (y así sucesivamente con el resto de tarjetas) -->
      <article
        class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300">
        <a href="#">
          <div class="relative flex items-end overflow-hidden rounded-xl">
      ...
      <!-- Repite el mismo patrón para las demás tarjetas que quieras mostrar -->
    </div>
  </section>
</template>
